...
HD_PWD='D:/Projects/karatsuba_multiplier/karatsuba_multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mul64_v2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mul64_v2.tcl -notrace
