...
HD_PWD='D:/Projects/karatsuba_multiplier/karatsuba_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul64_v2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul64_v2.tcl
